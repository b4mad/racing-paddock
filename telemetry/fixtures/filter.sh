...
cat ../fixtures.all/game.json > game.json
# jq '[.[] | select(.fields.game == 1 or .fields.game == 5)]' ../fixtures.all/car.json > car.json
jq '[.[] | select(.pk == 9 or .pk == 351 or .pk == 1280 or .pk == 260 or (.fields.name == "Mazda MX-5 Cup" and .fields.game == 1) or (.fields.name == "Mitsubishi Lancer Evo X R4") )]' ../fixtures.all/car.json > car.json
jq '[.[] | select(.pk == 409 or .pk == 83 or .pk == 1040 or .pk == 193 or .pk == 37 or .pk == 129 or .pk == 352 or .pk == 206 or .pk == 55 or .pk == 448 or .pk == 1029 or .pk == 3165)]' ../fixtures.all/track.json > track.json
...
cat ../fixtures.all/fastlap.json > fastlap.json
jq '[.[] | select(.fields.fast_lap == 703 or .fields.fast_lap == 157 or .fields.fast_lap == 1237 or .fields.fast_lap == 4021 or .fields.fast_lap == 1591 or .fields.fast_lap == 8787)]' ../fixtures.all/fastlapsegment.json > fastlapsegment.json
